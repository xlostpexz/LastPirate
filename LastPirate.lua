function CheckLevel()
    local Lv = game.Players.LocalPlayer.PlayerStats.Level.Value
...
elseif Lv >= 15 and Lv <= 29 then 
        ...
        Qn = "Pirates"
            ...
            elseif Lv >= 30 and Lv <= 59 then

        _G.Ms = "BagyPirates [Lv:30]"

        Qn = "BagyPirates"

    elseif Lv >= 60 and Lv <= 149 then

        _G.Ms = "Clown Pirate [Lv:60]"

        Qn = "Clown Pirate"

    elseif Lv >= 150 and Lv <= 199 then

        _G.Ms = "Revolutionary Troop [Lv:150]"

        Qn = "Revolutionary Troop"

    elseif Lv >= 200 and Lv <= 499 then

        _G.Ms = "Marines [Lv:200]"

        Qn = "Marines"

    elseif Lv >= 500 and Lv <= 599 then

       _G.Ms = "Marines [Lv:200]"

        Qn = "Marines"

    elseif Lv >= 600 and Lv <= 699 then

        _G.Ms = "Fishman [Lv:600]"

        Qn = "Fishman"

    elseif Lv >= 700 and Lv <= 849 then

        _G.Ms = "WinterBandit [Lv:700]"

        Qn = "WinterBandit"

    elseif Lv >= 850 and Lv <= 949 then

        _G.Ms = "Sky Bandit [Lv:850]"

        Qn = "Sky Bandit"

    elseif Lv >= 950 and Lv <= 1149 then
    ...
    elseif Lv >= 1200 and Lv <= 1399 then 
...
for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
    ...
    Home:CreateToggle("Auto Farm Level [Above]",function(value)
       _G.Auto2 = value
       _G.A = value
       _G.NoClip = value
    end)
    
    Home:CreateToggle("Auto Farm Level [Under]",function(value)
       _G.Auto1 = value
       _G.A = value
       _G.NoClip = value
    end)
    
    Home:CreateDropdown("Please Select Your Weapon",Weaponlist ,function(value)
        Weapon = value
    end)
    
    Home:CreateToggle("Auto Eqiup",function(value)
        _G.Eqiup = value
    end)
                            ...
                            if v.Name == _G.Ms then
                                ...
                                pcall(function()
                                    ...
                                    if string.find(game:GetService("Players").LocalPlayer.Quest.Doing.Value, Qn) then
                                        ...
                                        until v.Humanoid.Health <= 0 or _G.Auto1 == false
                            ...
                            if v.Name == _G.Ms then
                                ...
                                pcall(function()
                                    ...
                                    if string.find(game:GetService("Players").LocalPlayer.Quest.Doing.Value, Qn) then
                                        ...
                                        until v.Humanoid.Health <= 0 or _G.Auto2 == false
